...
<html lang="fr">
    ...
    <body>
        ...
        <div>
            <h1 class="center titrePage">Accueil</h1>
        </div>


        <?php
        $pdo = new PDO('mysql:host=localhost;dbname=articlesblog;charset=utf8', 'root', '', array(PDO::ATTR_ERRMODE=>PDO::ERRMODE_EXCEPTION));
